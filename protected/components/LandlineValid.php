...
class LandlineValid extends CValidator {
    ...
    protected function validateAttribute($object, $attribute) {
        ...
        if (empty($object->$attribute)) {
            ...
            $translated_msg = Yii::t("LandlineValid.general", $this->emptyMessage, array('{attribute}' => $attribute));
        ...
        $translated_msg = Yii::t("LandlineValid.general", $this->message);
        $this->addError($object, $attribute, $translated_msg);
    }
}
