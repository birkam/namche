...
<table width="870" height="550" border="0" align="center" cellpadding="0" cellspacing="0" class="print-receipt">
    ...
    <tr>
        ...
        <th align="left" scope="col"><em> &nbsp;&nbsp;&nbsp; <?php echo $queueDate;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $routeTime->route_time;?></em></th>
    </tr>
    <tr>
                ...
                <tr>
                    ...
                    <td width="10%" align="right" scope="col">
                        <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                            ...
                            $total = 0;
                            if(!empty($CheckedRouteCost)){?>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->samiti_sulka;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->bhalai_kosh;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->samrakshan;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->ticket;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->sahayog;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->bima;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->bibidh;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->mandir;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->jokhim;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->anugaman;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->bi_bya_sulka;?></td></tr>
                                <tr><td align="right"><?php echo  'Rs. '.$CheckedRouteCost->ma_kosh;?></td></tr>
                            <?php
                            }
                            if(!empty($check_rate)){
                                foreach($check_rate_arr as $keyr=>$valr){
                                    ?>
                                    <tr>
                                        <td align="right"><?php echo 'Rs. '.$valr;?></td>
                                    </tr>
                                    <?php
                                    $total = $total + $valr;
                                }
                            ...
                            if(!empty($others)){?>
                                <tr>
                                    <td align="right"><?php echo 'Rs. '.$others_amount;?></td>
                                </tr>
                            <?php } ?>
                        </table>
                    </td>
