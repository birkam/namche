...
if(!empty($CheckedRouteCost)){
    ...
    $routeCost_arr = explode(',',$CheckedRouteCost->route_cost);
    $routeCost = array_sum($routeCost_arr);
...
<table  border="0" align="center" cellpadding="0" cellspacing="0" >
    <tr>
        ...
        <td width="190" align="left" scope="col">Date: <?php echo $model->created_date;?></td>
    </tr>
    <tr>
        <td align="left" scope="col">Bus No : &nbsp;<?php echo $bus_no;?></td>
        <td align="right" scope="col">Queue/Reserve Date: </td>
        <td align="left" scope="col"> &nbsp;&nbsp;2072/10/25</td>
        <td align="left" scope="col">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2072/10/25 </td>
    </tr>
    <tr>
                ...
                <tr>
                    ...
                    <td width="20%" align="right" valign="top" scope="col">
                        ...
                        <table width="100%" border="0"    cellspacing="0" cellpadding="0">
                            ...
                            $total = 0;
                            if(!empty($CheckedRouteCost)){
                                foreach($routeCost_arr as $key=>$val){ ?>
                                    <tr><td align="right"><?php echo   $val;?></td></tr>
                                <?php
                                }
                            }
                            if(!empty($check_rate)){
