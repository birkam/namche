        ...
        <td><table width="600" border="0" align="center" cellpadding="1" cellspacing="0">
                    ...
                    <td colspan="2"><table width="600" border="0" align="left" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td><table width="300" border="2" cellspacing="0" cellpadding="0">
                                        ...
                                        $total = 0;
                                        if(!empty($CheckedRouteCost)){ ?>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->samiti_sulka;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->bhalai_kosh;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->samrakshan;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->ticket;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->sahayog;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->bima;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->bibidh;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->mandir;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->jokhim;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->anugaman;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->bi_bya_sulka;?></td></tr>
                                            <tr><td><?php echo  'Rs. '.$CheckedRouteCost->ma_kosh;?></td></tr>
                                        <?php
                                        }
                                        if(!empty($check_rate)){
                                        ...
                                        if(!empty($others)){?>
                                            <tr>
                                                <td><?php echo 'Rs. '.$others_amount;?></td>
                                            </tr>
                                        <?php } ?>
                                        <tr>
                                            <td><?php
                ...
                <tr>
                    ...
                    <td height="72" align="left" valign="top">
                        <?php if(!empty($CheckedRouteCost)){?>
                            <p>Queuing Date : <?php echo $queueDate.' '.$routeTime->route_time;?></p>
                            <p>Towards :
                            </p><?php } ?></td>
